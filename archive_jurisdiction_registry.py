...
_REGISTRY: Dict[str, ArchiveJurisdiction] = {
    ...
    "modica": ArchiveJurisdiction(
        comune="Modica",
        provincia="Ragusa",
        distretto_militare="Siracusa",
        archivio_di_stato="Archivio di Stato di Siracusa",
        archivio_di_stato_url="https://archiviodistatosiracusa.beniculturali.it/",
        fondo_matricolare="Rubriche Fogli Matricolari",
        note="Distretto militare di Siracusa (competente per Modica in periodo WWI)",
    ),
    "san lorenzo": ArchiveJurisdiction(
        comune="San Lorenzo",
        provincia="Reggio Calabria",
        distretto_militare="Reggio Calabria",
        archivio_di_stato="Archivio di Stato di Reggio Calabria",
        archivio_di_stato_url="https://archiviodistatoreggiocalabria.beniculturali.it/",
        fondo_matricolare="Rubriche Fogli Matricolari",
        note="Distretto militare di Reggio Calabria",
    ),
    "casaluce": ArchiveJurisdiction(
        comune="Casaluce",
        provincia="Caserta",
        distretto_militare="Caserta",
        archivio_di_stato="Archivio di Stato di Caserta",
        archivio_di_stato_url="https://archiviodistatocaserta.beniculturali.it/",
        fondo_matricolare="Rubriche Fogli Matricolari",
        note="Distretto militare di Caserta",
    ),
    "brienza": ArchiveJurisdiction(
        comune="Brienza",
        provincia="Potenza",
        distretto_militare="Potenza",
        archivio_di_stato="Archivio di Stato di Potenza",
        archivio_di_stato_url="https://archiviodistatopotenza.beniculturali.it/",
        fondo_matricolare="Rubriche Fogli Matricolari",
        note="Distretto militare di Potenza",
    ),
    "lettere": ArchiveJurisdiction(
        comune="Lettere",
        provincia="Napoli",
        distretto_militare="Napoli",
        archivio_di_stato="Archivio di Stato di Napoli",
        archivio_di_stato_url="https://archiviodistatonapoli.beniculturali.it/",
        fondo_matricolare="Rubriche Fogli Matricolari",
        note="Distretto militare di Napoli",
    ),
}
