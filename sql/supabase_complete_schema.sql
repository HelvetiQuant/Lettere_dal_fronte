-- ============================================================
-- VOCI DAL FRONTE ? Schema Completo per Supabase (PostgreSQL)
-- ============================================================
-- Generato automaticamente da migrate_to_supabase.py
-- Incolla questo SQL nel Supabase Dashboard ? SQL Editor
-- ============================================================

-- STEP 0: Funzione helper per esecuzione SQL via PostgREST
...
-- acquisitions (0 righe in SQLite)
...
-- ai_providers (6 righe in SQLite)
...
-- ai_ricerche (217 righe in SQLite)
...
-- ai_routing_policies (21 righe in SQLite)
...
-- ai_task_runs (74 righe in SQLite)
...
-- ai_usage_ledger (64 righe in SQLite)
...
-- api_usage (10,624 righe in SQLite)
...
-- archival_metadata (0 righe in SQLite)
...
-- archive_connectors (27 righe in SQLite)
...
-- archivio_documenti (433 righe in SQLite)
...
-- archivio_fonti (1,153 righe in SQLite)
...
-- budget_reservations (0 righe in SQLite)
...
-- caduti_albooro (342,555 righe in SQLite)
...
-- caduti_bologna (9,656 righe in SQLite)
...
-- caduti_cwgc (506,446 righe in SQLite)
...
-- caduti_francia_ww1 (24,279 righe in SQLite)
...
-- caduti_ministero (162,646 righe in SQLite)
...
-- caduti_sardi (20,435 righe in SQLite)
...
-- claim_evidence (550 righe in SQLite)
...
-- claim_relations (102 righe in SQLite)
...
-- collegamenti (2,349,417 righe in SQLite)
...
-- compliance_authorizations (0 righe in SQLite)
...
-- compliance_decisions (0 righe in SQLite)
...
-- compliance_review_queue (0 righe in SQLite)
...
-- consolidated_memory (1 righe in SQLite)
...
-- content_fingerprints (0 righe in SQLite)
...
-- decorati (1,286 righe in SQLite)
...
-- decorati_nastroazzurro (279,832 righe in SQLite)
...
-- document_extractions (0 righe in SQLite)
...
-- documenti_nara_catalog (272 righe in SQLite)
...
-- documenti_nara_t315 (1,153 righe in SQLite)
...
-- edge_evidence (0 righe in SQLite)
...
-- edge_versions (0 righe in SQLite)
...
-- entita (688,739 righe in SQLite)
...
-- entity_match_candidates (0 righe in SQLite)
...
-- entity_variants (299 righe in SQLite)
...
-- event_aliases (90 righe in SQLite)
...
-- event_links (891,874 righe in SQLite)
CREATE TABLE IF NOT EXISTS "event_links" (
    "id" SERIAL PRIMARY KEY,
    "evento_id" INTEGER NOT NULL,
    "target_table" TEXT NOT NULL,
...
-- external_access_requests (0 righe in SQLite)
...
-- external_digital_objects (0 righe in SQLite)
...
-- external_import_jobs (2 righe in SQLite)
...
-- external_person_mentions (0 righe in SQLite)
...
-- external_record_links (0 righe in SQLite)
...
-- external_source_facts (0 righe in SQLite)
...
-- external_source_records (1 righe in SQLite)
...
-- fondi_archivistici (4,808 righe in SQLite)
...
-- fonti_indice (35,664 righe in SQLite)
...
-- fonti_narrative (40 righe in SQLite)
...
-- fonti_risorse (0 righe in SQLite)
...
-- generated_narratives (0 righe in SQLite)
...
-- graph_edge_reviews (0 righe in SQLite)
...
-- graph_integrity_issues (0 righe in SQLite)
...
-- graph_pipeline_runs (0 righe in SQLite)
...
-- internati (20,465 righe in SQLite)
...
-- lettere_personali (1 righe in SQLite)
...
-- map_features (0 righe in SQLite)
...
-- memory_trace (55 righe in SQLite)
...
-- menzioni (10,976 righe in SQLite)
...
-- nara_catalog_files (0 righe in SQLite)
...
-- permitted_operations (68 righe in SQLite)
...
-- populate_progress (8,516 righe in SQLite)
...
-- prompt_versions (1 righe in SQLite)
...
-- publication_versions (0 righe in SQLite)
...
-- rc_administrative_cases (0 righe in SQLite)
...
-- rc_ai_analyses (28 righe in SQLite)
...
-- rc_audit_log (164 righe in SQLite)
...
-- rc_candidates (83 righe in SQLite)
...
-- rc_communications (0 righe in SQLite)
...
-- rc_contact_attempts (0 righe in SQLite)
...
-- rc_descendant_cases (0 righe in SQLite)
...
-- rc_descendant_contacts (0 righe in SQLite)
...
-- rc_descendant_packages (0 righe in SQLite)
...
-- rc_document_checklists (0 righe in SQLite)
...
-- rc_document_versions (1 righe in SQLite)
...
-- rc_documents (0 righe in SQLite)
...
-- rc_family_persons (0 righe in SQLite)
...
-- rc_historical_events (45 righe in SQLite)
...
-- rc_institutional_contacts (0 righe in SQLite)
...
-- rc_invitations (0 righe in SQLite)
...
-- rc_kinship_links (0 righe in SQLite)
...
-- rc_practice_deadlines (0 righe in SQLite)
...
-- rc_practice_documents (1 righe in SQLite)
...
-- rc_practices (0 righe in SQLite)
...
-- rc_recognition_assessments (50 righe in SQLite)
...
-- rc_recognition_types (12 righe in SQLite)
...
-- rc_sessions (44 righe in SQLite)
...
-- rc_state_transitions (0 righe in SQLite)
...
-- record_link_validations (200 righe in SQLite)
...
-- record_links (169,184 righe in SQLite)
...
-- research_cycles (50 righe in SQLite)
...
-- research_gaps (472 righe in SQLite)
...
-- research_hits (0 righe in SQLite)
...
-- research_plans (46 righe in SQLite)
...
-- research_queries (0 righe in SQLite)
...
-- research_results (0 righe in SQLite)
...
-- research_sessions (46 righe in SQLite)
...
-- research_subject_sources (1,431 righe in SQLite)
...
-- research_subjects (118 righe in SQLite)
...
-- source_access_audit (0 righe in SQLite)
...
-- source_fetch_cache (14 righe in SQLite)
...
-- source_policies (4 righe in SQLite)
...
-- source_rights (0 righe in SQLite)
...
-- stable_locators (0 righe in SQLite)
...
CREATE INDEX IF NOT EXISTS idx_cwgc_cognome_nocase ON caduti_cwgc(cognome COLLATE NOCASE);
