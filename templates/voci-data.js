...
it: {
  ...
  heroTitle1:"Ogni nome, ogni fonte,", heroTitle2:"ricomposti.",
  heroSubtitle:"Interroga in un'unica ricerca i database di soldati, internati, caduti e decorati e gli archivi internazionali federati — Arolsen, Bundesarchiv, TNA, CWGC, Gallica e altri sedici enti.",
...
en: {
  ...
  heroTitle1:"Every name, every source,", heroTitle2:"reassembled.",
  heroSubtitle:"One search across soldier, internee, casualty and decoration records — and sixteen federated international archives: Arolsen, Bundesarchiv, TNA, CWGC, Gallica and more.",
...
de: {
  ...
  heroTitle1:"Jeder Name, jede Quelle,", heroTitle2:"neu zusammengefügt.",
  heroSubtitle:"Eine Suche über Soldaten-, Internierten-, Gefallenen- und Auszeichnungsregister — und sechzehn föderierte internationale Archive: Arolsen, Bundesarchiv, TNA, CWGC, Gallica und weitere.",
...
fr: {
  ...
  heroTitle1:"Chaque nom, chaque source,", heroTitle2:"recomposés.",
  heroSubtitle:"Une seule recherche sur les registres de soldats, internés, victimes et décorations — et seize archives internationales fédérées : Arolsen, Bundesarchiv, TNA, CWGC, Gallica et d'autres.",
