...
def _ensure_diversity(claims: List[Dict[str, Any]], budget: int) -> List[Dict[str, Any]]:
    ...
    """
    categories = {
        "identity": ["full_birth_date", "birth_year", "birth_place", "paternity", "residence", "municipality", "draft_class"],
        "military": ["rank", "unit", "service_number", "decoration_type", "decoration_year"],
        "chronology": ["capture_date", "capture_place", "death_date", "death_year", "event_start_date", "event_end_date"],
        "location": ["internment_place", "death_place", "burial", "event_location", "captivity"],
